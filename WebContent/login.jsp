...
<div style="padding: 0px 50px">
		<form action="login" method="post">
			<p><label for="username">用户名:<br />
				<input id="username" title="数字或英文。" type="text" name="username" class="input"
					value="" size="20" tabindex="10" placeholder="name"/> </label>
			</p>
			<p>
				<label for="password">密码:<br /> 
				<input type="password" name="password"
					id="password" title="数字或英文。"class="input" value="" size="10" tabindex="20" placeholder="password" /> </label>
			</p>
			<p class="submit">
				<input type="submit" name="wp-submit"
					id="wp-submit" class="button-primary" value="Login" tabindex="100" />
			</p>
		</form>
		</div>
